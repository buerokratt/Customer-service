...
import { AUTHOR_ROLES, CHAT_STATUS, MESSAGE_MAX_CHAR_LIMIT, MESSAGE_VISIBILITY_LIMIT, MESSAGE_WARNING_CHAR_LIMIT } from '../../../../utils/constants';
...
const ChatKeypad = (props: HTMLAttributes<HTMLElement>): JSX.Element => {
  ...
  const removeExcessiveNewlines = (): string =>
    userInput
      .trim()
      .replaceAll(/ +(\n|\\n)|(\n|\\n) +/g, '\\n')
      .replaceAll(/ *(\n|\\n){3,} */g, '\\n\\n')
  ...
  const addNewMessageToState = (): void => {
    ...
    const message: MessageModel = {
      ...
      content: removeExcessiveNewlines(),
